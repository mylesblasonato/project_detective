...
namespace Unity.FPS.AI
{
    ...
    public class EnemyController : MonoBehaviour
    {
        ...
        public bool TryAtack(Vector3 enemyPosition)
        {
            ...
            // Shoot the weapon
            bool didFire = GetCurrentWeapon().HandleShootInputs(false, true, false, true);
            bool didAim = GetCurrentWeapon().HandleShootInputs(false, true, false, false);

            if (didFire && onAttack != null || didAim && onAttack != null)
            {
                onAttack.Invoke();
