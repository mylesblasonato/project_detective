...
namespace Unity.FPS.Game
{
    ...
    public class WeaponController : MonoBehaviour
    {
        ...
        public bool HandleShootInputs(bool inputDown, bool inputHeld, bool inputUp, bool leftMouse)
        {
            ...
            switch (ShootType)
            {
                ...
                case WeaponShootType.Charge:
                    ...
                    {
                        return TryReleaseCharge(leftMouse);
                    }
        ...
        bool TryShoot(bool leftMouse)
        {
            if (m_CurrentAmmo >= 1f
                && m_LastTimeShot + DelayBetweenShots < Time.time)
            {
                HandleShoot(leftMouse);
                m_CurrentAmmo -= 1f;
        ...
        bool TryReleaseCharge(bool leftMouse)
        {
            if (IsCharging)
            {
                HandleShoot(leftMouse);
        ...
        void HandleShoot(bool leftMouse)
        {
